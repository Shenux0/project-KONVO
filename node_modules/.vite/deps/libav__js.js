...
// node_modules/libav.js/dist/libav-default.mjs
var libav = {};
(function() {
  function isWebAssemblySupported2(module) {
  ...
  function isThreadingSupported2() {
    try {
  ...
  libav.isWebAssemblySupported = isWebAssemblySupported2;
  libav.isThreadingSupported = isThreadingSupported2;
  function target2(opts) {
    opts = opts || {};
    var wasm = !opts.nowasm && isWebAssemblySupported2();
    var thr = opts.yesthreads && wasm && !opts.nothreads && isThreadingSupported2();
    if (!wasm)
      return "asm";
    else if (thr)
      return "thr";
  ...
  libav.target = target2;
  libav.VER = "6.7.7.1.1";
  libav.CONFIG = "default";
  libav.DBG = "";
  libav.factories = {};
  var libavStatics = {};
  ...
  libav.LibAV = function(opts) {
    opts = opts || {};
    var base2 = opts.base || libav.base;
    var t = target2(opts);
    var variant = opts.variant || libav.variant || "default";
    var useES6 = true;
    if (useES6 && (opts.noes6 || libav.noes6))
      useES6 = false;
    var toImport = opts.toImport || libav.toImport || base2 + "/libav-6.7.7.1.1-" + variant + "." + t + "." + (useES6 ? "mjs" : "js");
    var ret;
    var mode = "direct";
    if (t === "thr")
      mode = "threads";
...
export {
  ...
  base,
  bigIntToi64,
  libav_default_default as default,
  f64toi64,
  factories,
  ff_channel_layout,
  ff_channels,
...
//# sourceMappingURL=libav__js.js.map
